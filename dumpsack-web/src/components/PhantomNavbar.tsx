      ...
      >
        <div className="container-custom flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              to="/download"
              className="hidden md:inline-flex bg-white/10 hover:bg-white/20 text-white font-semibold text-sm px-6 py-2.5 rounded-full transition-all hover:scale-105 active:scale-95"
            >
              Download
            </Link>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed inset-0 z-40 bg-void pt-24 px-6 lg:hidden overflow-y-auto"
          >
